...
export const nicknameValidate = (value) =>async dispatch=>{
    ...
    dispatch({
        type: types.AUTH_SET_NICKNAME_ERROR,
        errors: errorsResult[field],
    });
    dispatch({
        type: types.AUTH_CHANGED_NICKNAME_STATE,
        changed: true,
    });
};
...
export const signin = (nickname, password) =>async dispatch=>{
    const params = new URLSearchParams();
    params.append('nickname', nickname);
    params.append('password', password);
